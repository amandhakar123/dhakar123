    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted relative overflow-hidden">
      ...
      <main className="relative z-10 container mx-auto px-6 py-12">
        ...
        <div className={`grid md:grid-cols-3 gap-10 max-w-7xl mx-auto mb-20 transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
          {/* Enhanced Student Card with Indian Flag Colors */}
          <Card
            className="group p-8 hover:shadow-2xl transition-all duration-500 cursor-pointer border-2 hover:border-orange-500/50 hover:scale-[1.02] bg-gradient-to-br from-orange-50/50 to-orange-100/30 dark:from-orange-950/50 dark:to-orange-900/30 backdrop-blur-sm hover:-translate-y-2"
            onClick={() => onRoleSelect("student")}
          >
            <CardHeader className="text-center pb-6">
              <div className="mx-auto mb-6 p-6 bg-gradient-to-br from-orange-500/20 to-orange-400/10 rounded-3xl w-fit group-hover:scale-110 transition-all duration-300 group-hover:rotate-3 shadow-xl">
                <GraduationCap className="h-16 w-16 text-orange-600 group-hover:animate-bounce" />
              </div>
              <CardTitle className="text-3xl font-bold text-gray-800 dark:text-gray-100 group-hover:text-orange-600 transition-colors duration-300">
                {t('role.student')}
              </CardTitle>
